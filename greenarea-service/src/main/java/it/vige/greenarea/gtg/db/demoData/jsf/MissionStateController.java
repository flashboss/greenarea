...
import static it.vige.greenarea.dto.StatoMissione.valueOf;
...
@SessionScoped
public class MissionStateController implements Serializable {

	private static final long serialVersionUID = -6076424677053174191L;
	private StatoMissione current;

	public MissionStateController() {
	}

	public StatoMissione getSelected() {
		if (current == null) {
			current = WAITING;
		}
		return current;
	...
	public static class StatoMissioneControllerConverter implements Converter {
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof StatoMissione) {
