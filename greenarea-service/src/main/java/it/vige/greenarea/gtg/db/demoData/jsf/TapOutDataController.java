...
public class TapOutDataController implements Serializable {
	...
	public String create() {
		try {
			...
			addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TapOutDataCreated"));
	...
	public String update() {
		try {
			...
			addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TapOutDataUpdated"));
			return "View";
		} catch (Exception e) {
			addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
			return null;
	...
	private void performDestroy() {
		try {
			...
			addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TapOutDataDeleted"));
		} catch (Exception e) {
			addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
		}
	}
