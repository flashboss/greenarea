...
public class TapGroupDataController implements Serializable {
	...
	public String create() {
		try {
			...
			addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TapGroupDataCreated"));
	...
	public String update() {
		try {
			...
			addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TapGroupDataUpdated"));
			return "View";
		} catch (Exception e) {
			addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
			return null;
	...
	private void performDestroy() {
		try {
			...
			addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TapGroupDataDeleted"));
		} catch (Exception e) {
			addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
		}
	}
