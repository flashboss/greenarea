 ...
 *         &lt;element name="params" type="{http://tap.vige.it/spReceiver/ws}paramData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GroupData {
    ...
    protected List<ParamData> params;
    ...
    public List<ParamData> getParams() {
        if (params == null) {
            params = new ArrayList<ParamData>();
        }
        return this.params;
    }
