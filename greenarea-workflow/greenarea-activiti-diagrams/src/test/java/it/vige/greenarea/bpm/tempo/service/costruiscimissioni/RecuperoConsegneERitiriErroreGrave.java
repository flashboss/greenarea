...
public class RecuperoConsegneERitiriErroreGrave extends
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		String eseguito = (String) execution
				.getVariable("test_recupero_consegne_e_ritiri_errore_grave_eseguito");
		if (eseguito == null) {
			logger.info("Recupero Consegne e Ritiri Errore Grave");
			execution.setVariable(
					"test_recupero_consegne_e_ritiri_errore_grave_eseguito",
					"OK");
