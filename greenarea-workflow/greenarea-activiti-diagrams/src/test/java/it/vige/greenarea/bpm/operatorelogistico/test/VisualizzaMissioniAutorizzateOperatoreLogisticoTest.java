...
import it.vige.greenarea.bpm.operatorelogistico.service.visualizzamissioniautorizzate.NotificaErrorePolicyMancanti;
import it.vige.greenarea.bpm.operatorelogistico.service.visualizzamissioniautorizzate.NotificaErroreRecuperoDatiMissioni;
import it.vige.greenarea.bpm.operatorelogistico.service.visualizzamissioniautorizzate.NotificaErroreRecuperoDatiPolicy;
import it.vige.greenarea.bpm.operatorelogistico.service.visualizzamissioniautorizzate.RecuperoDatiMissioniPopolate;
import it.vige.greenarea.bpm.operatorelogistico.service.visualizzamissioniautorizzate.RecuperoDatiPolicyPopolate;
...
public class VisualizzaMissioniAutorizzateOperatoreLogisticoTest extends
	...
	public VisualizzaMissioniAutorizzateOperatoreLogisticoTest() {
	...
	public void testDettaglioOK() {
		...
		runtimeService.startProcessInstanceByKey(
				"visualizzaMissioniAutorizzateOp", variables);
		...
		List<HistoricActivityInstance> notificaErroreReperimentoDatiMissioniAOperatoreLogistico = historyService
				.createHistoricActivityInstanceQuery()
				.activityId(
						"notificaErroreReperimentoDatiMissioniAOperatoreLogistico")
				.list();
		assertEquals(
				notificaErroreReperimentoDatiMissioniAOperatoreLogistico.size(),
				0);
		...
		assertEquals(notificaErroreReperimentoDatiPolicyAAmministratore.size(),
				0);
		List<HistoricActivityInstance> notificaErroreReperimentoDatiPolicyAOperatoreLogistico = historyService
				.createHistoricActivityInstanceQuery()
				.activityId(
						"notificaErroreReperimentoDatiPolicyAOperatoreLogistico")
				.list();
		assertEquals(
				notificaErroreReperimentoDatiPolicyAOperatoreLogistico.size(),
				0);
		...
		List<HistoricActivityInstance> notificaDatiPolicyMancantiAOperatoreLogistico = historyService
				.createHistoricActivityInstanceQuery()
				.activityId("notificaDatiPolicyMancantiAOperatoreLogistico")
				.list();
		assertEquals(notificaDatiPolicyMancantiAOperatoreLogistico.size(), 0);
	...
	public void testNotificaErrorePolicyMancanti() {
		...
		List<HistoricActivityInstance> notificaDatiPolicyMancantiAOperatoreLogistico = historyService
				...
				.activityId("notificaDatiPolicyMancantiAOperatoreLogistico")
				.list();
		assertEquals(notificaDatiPolicyMancantiAOperatoreLogistico.size(), 1);
