...
import it.vige.greenarea.bpm.trasportatoreautonomo.service.monitoringmissioni.RecuperaMissioniConNotificaErroreReperimentoMissioni;
import it.vige.greenarea.bpm.trasportatoreautonomo.service.monitoringmissioni.RichiediMissionePopolata;
...
public class MonitoringMissioniTrasportatoreAutonomoTest extends
	...
	public MonitoringMissioniTrasportatoreAutonomoTest() {
		super("activiti.cfg-mem.xml");
	}

	@Deployment(resources = { "it/vige/greenarea/bpm/trasportatoreautonomo/monitoring_missioni.bpmn20.xml" })
	public void testMonitoringMissioniOK() {
		...
		// INIZIO PROCESSO
		runtimeService.startProcessInstanceByKey("monitoringMissioniTr",
				variables);
		...
		assertEquals(segnalazioneErroreRichiestaMissioneAAmministratore.size(),
				0);
		List<HistoricActivityInstance> segnalazioneErroreRichiestaMissioneATrasportatoreAutonomo = historyService
				.createHistoricActivityInstanceQuery()
				.activityId(
						"segnalazioneErroreRichiestaMissioneATrasportatoreAutonomo")
				.list();
		assertEquals(
				segnalazioneErroreRichiestaMissioneATrasportatoreAutonomo
						.size(),
