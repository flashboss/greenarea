...
import it.vige.greenarea.bpm.trasportatoreautonomo.service.performanceveicoli.RichiediVeicoliConSegnalazioneErrore;
...
public class PerformanceVeicoliTrasportatoreAutonomoTest extends
	...
	public PerformanceVeicoliTrasportatoreAutonomoTest() {
		super("activiti.cfg-mem.xml");
	}

	@Deployment(resources = { "it/vige/greenarea/bpm/trasportatoreautonomo/performance_veicoli.bpmn20.xml" })
	public void testPerformanceMissioniOK() {
		...
		// INIZIO PROCESSO
		runtimeService.startProcessInstanceByKey("performanceVeicoliTr",
				variables);
		...
		assertEquals(segnalazioneErroreRichiediVeicoliAAmministratore.size(),
				0);
		List<HistoricActivityInstance> segnalazioneErroreRichiediVeicoliATrasportatoreAutonomo = historyService
				.createHistoricActivityInstanceQuery()
				.activityId(
						"segnalazioneErroreRichiediVeicoliATrasportatoreAutonomo")
				.list();
		assertEquals(
				segnalazioneErroreRichiediVeicoliATrasportatoreAutonomo.size(),
				0);
