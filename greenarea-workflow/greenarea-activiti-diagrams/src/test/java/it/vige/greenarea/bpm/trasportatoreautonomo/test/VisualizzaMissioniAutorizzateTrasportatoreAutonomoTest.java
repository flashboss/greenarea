...
import it.vige.greenarea.bpm.trasportatoreautonomo.service.visualizzamissioniautorizzate.NotificaErrorePolicyMancanti;
import it.vige.greenarea.bpm.trasportatoreautonomo.service.visualizzamissioniautorizzate.NotificaErroreRecuperoDatiMissioni;
import it.vige.greenarea.bpm.trasportatoreautonomo.service.visualizzamissioniautorizzate.NotificaErroreRecuperoDatiPolicy;
import it.vige.greenarea.bpm.trasportatoreautonomo.service.visualizzamissioniautorizzate.RecuperoDatiMissioniPopolate;
import it.vige.greenarea.bpm.trasportatoreautonomo.service.visualizzamissioniautorizzate.RecuperoDatiPolicyPopolate;
import it.vige.greenarea.bpm.trasportatoreautonomo.visualizzamissioniautorizzate.EmptyRecuperoDatiPolicy;
...
public class VisualizzaMissioniAutorizzateTrasportatoreAutonomoTest extends
	...
	public VisualizzaMissioniAutorizzateTrasportatoreAutonomoTest() {
	...
	public void testDettaglioOK() {
		...
		runtimeService.startProcessInstanceByKey(
				"visualizzaMissioniAutorizzateTr", variables);
		...
		List<HistoricActivityInstance> notificaErroreReperimentoDatiMissioniATrasportatoreAutonomo = historyService
				.createHistoricActivityInstanceQuery()
				.activityId(
						"notificaErroreReperimentoDatiMissioniATrasportatoreAutonomo")
				.list();
		assertEquals(
				notificaErroreReperimentoDatiMissioniATrasportatoreAutonomo
						.size(),
		...
		assertEquals(notificaErroreReperimentoDatiPolicyAAmministratore.size(),
				0);
		List<HistoricActivityInstance> notificaErroreReperimentoDatiPolicyATrasportatoreAutonomo = historyService
				.createHistoricActivityInstanceQuery()
				.activityId(
						"notificaErroreReperimentoDatiPolicyATrasportatoreAutonomo")
				.list();
		assertEquals(
				notificaErroreReperimentoDatiPolicyATrasportatoreAutonomo
						.size(),
		...
		List<HistoricActivityInstance> notificaDatiPolicyMancantiATrasportatoreAutonomo = historyService
				.createHistoricActivityInstanceQuery()
				.activityId("notificaDatiPolicyMancantiATrasportatoreAutonomo")
				.list();
		assertEquals(notificaDatiPolicyMancantiATrasportatoreAutonomo.size(), 0);
	...
	public void testNotificaErrorePolicyMancanti() {
		...
		List<HistoricActivityInstance> notificaDatiPolicyMancantiATrasportatoreAutonomo = historyService
				...
				.activityId("notificaDatiPolicyMancantiATrasportatoreAutonomo")
				.list();
		assertEquals(notificaDatiPolicyMancantiATrasportatoreAutonomo.size(), 1);
