...
public class RecuperaParametriPerModifica extends EmptyRecuperaParametriPerModifica {
	...
	public void execute(DelegateExecution execution) throws Exception {
		try {
			...
			@SuppressWarnings("unchecked")
			List<Parametro> parametriAggiunti = (List<Parametro>) execution.getVariable("parametriaggiunti");
