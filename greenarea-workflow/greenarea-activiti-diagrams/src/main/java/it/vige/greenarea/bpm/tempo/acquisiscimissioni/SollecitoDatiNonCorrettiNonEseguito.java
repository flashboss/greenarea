...
public class SollecitoDatiNonCorrettiNonEseguito implements JavaDelegate {

	private Logger logger = getLogger(getClass());

	@Override
	public void execute(DelegateExecution execution) throws Exception {
		logger.info("Sollecito Dati Non Corretti Non Eseguito");
		execution.setVariableLocal("sollecitodatinoncorrettieseguito", false);
