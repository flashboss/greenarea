...
public class SollecitoDatiMancantiEseguito implements JavaDelegate {

	private Logger logger = getLogger(getClass());

	@Override
	public void execute(DelegateExecution execution) throws Exception {
		logger.info("Sollecito Dati Mancanti Eseguito");
		execution.setVariableLocal("sollecitodatimancantieseguito", true);
