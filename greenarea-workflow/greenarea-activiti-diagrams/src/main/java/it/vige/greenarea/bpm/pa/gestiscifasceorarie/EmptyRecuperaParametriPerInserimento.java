...
public class EmptyRecuperaParametriPerInserimento implements JavaDelegate {

	private Logger logger = getLogger(getClass());

	@Override
	public void execute(DelegateExecution execution) throws Exception {
		logger.info("Recupera Parametri per Inserimento");
		execution.setVariable("parametrits", new ArrayList<Parametro>());
		execution.setVariable("parametriaggiunti", new ArrayList<Parametro>());
