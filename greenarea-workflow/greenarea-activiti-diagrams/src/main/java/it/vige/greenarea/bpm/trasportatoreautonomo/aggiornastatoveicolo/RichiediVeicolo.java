...
public class RichiediVeicolo extends EmptyRichiediVeicolo {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		User user = identityService.createUserQuery().userId(autista).singleResult();
		...
		List<Veicolo> veicoli = bldr.post(entity(veicolo, APPLICATION_JSON), new GenericType<List<Veicolo>>() {
		});
