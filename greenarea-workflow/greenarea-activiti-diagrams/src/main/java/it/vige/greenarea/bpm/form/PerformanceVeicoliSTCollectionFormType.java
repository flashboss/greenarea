...
public class PerformanceVeicoliSTCollectionFormType<T> extends AbstractFormType implements Serializable {

	private static final long serialVersionUID = 5873818481798420058L;
	private Map<String, T> values = new HashMap<String, T>();

	@Override
	public String getName() {
		return "performanceVeicoliST";
	}
