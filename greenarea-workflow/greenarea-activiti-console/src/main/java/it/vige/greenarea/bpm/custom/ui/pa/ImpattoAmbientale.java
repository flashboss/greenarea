...
import it.vige.greenarea.bpm.custom.ui.dettaglio.pa.impattoambientale.ImpattoAmbientalePage;
import it.vige.greenarea.bpm.custom.ui.dettaglio.pa.impattoambientale.ImpattoAmbientalePanel;
import it.vige.greenarea.bpm.custom.ui.form.GreenareaFormPropertiesForm;

public class ImpattoAmbientale extends AbstractProcessDefinitionDetailPanel {
	...
	public ImpattoAmbientale(String processDefinitionId, PADetailPanel detailPanel) {
	...
	public void goToDettaglio() {
		...
		Component detailComponent = new ImpattoAmbientalePanel(task,
				new ImpattoAmbientalePage(processInstance.getId(), mainTitle));
