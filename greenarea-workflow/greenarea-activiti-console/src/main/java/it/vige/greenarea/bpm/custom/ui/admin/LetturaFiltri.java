...
import it.vige.greenarea.bpm.custom.ui.dettaglio.admin.letturafiltri.LetturaFiltriPage;
import it.vige.greenarea.bpm.custom.ui.dettaglio.admin.letturafiltri.LetturaFiltriPanel;
...
public class LetturaFiltri extends AbstractProcessDefinitionDetailPanel {
	...
	private transient FormService formService = getDefaultProcessEngine()
			.getFormService();
	protected GreenareaFormPropertiesForm processDefinitionStartForm;

	private Label mainTitle;

	public LetturaFiltri(String processDefinitionId,
			AdminDetailPanel detailPanel) {
	...
	public void goToDettaglio() {
		...
		Component detailComponent = new LetturaFiltriPanel(task,
				new LetturaFiltriPage(processInstance.getId(), mainTitle));
