...
public class VisualizzaMissioniAutorizzateOpPage extends DettaglioPage {
	...
	public VisualizzaMissioniAutorizzateOpPage(String processInstanceId, Label mainTitle) {
	...
	protected Component createDetailComponent(String id) {
		...
		Component detailComponent = new VisualizzaMissioniAutorizzateOpPanel(task, this);
