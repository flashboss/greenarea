...
public class AggiornaStatoVeicoli extends AbstractProcessDefinitionDetailPanel {
	...
	public AggiornaStatoVeicoli(String processDefinitionId, SocietaDiTrasportoDetailPanel detailPanel) {
	...
	public void executeProcess() {
		...
		notificationManager.showInformationNotification(AGGIORNA_STATO_VEICOLI_ST_SELEZIONA);

		Task task = taskService.createTaskQuery().processInstanceId(processInstance.getId()).singleResult();
		Component detailComponent = new AggiornaStatoVeicoliStPanel(task,
				new AggiornaStatoVeicoliStPage(processInstance.getId(), mainTitle));
