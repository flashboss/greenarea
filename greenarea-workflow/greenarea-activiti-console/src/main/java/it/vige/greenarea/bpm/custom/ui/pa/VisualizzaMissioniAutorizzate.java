...
import it.vige.greenarea.bpm.custom.ui.dettaglio.pa.visualizzamissioniautorizzate.VisualizzaMissioniAutorizzatePAPage;
import it.vige.greenarea.bpm.custom.ui.dettaglio.pa.visualizzamissioniautorizzate.VisualizzaMissioniAutorizzatePAPanel;
...
public class VisualizzaMissioniAutorizzate extends AbstractProcessDefinitionDetailPanel {
	...
	public VisualizzaMissioniAutorizzate(String processDefinitionId, PADetailPanel detailPanel) {
	...
	public void goToDettaglio() {
		...
		Component detailComponent = new VisualizzaMissioniAutorizzatePAPanel(task,
				new VisualizzaMissioniAutorizzatePAPage(processInstance.getId(), mainTitle));
