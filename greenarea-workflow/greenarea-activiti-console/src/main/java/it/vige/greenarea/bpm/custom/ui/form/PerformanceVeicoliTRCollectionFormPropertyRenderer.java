...
public class PerformanceVeicoliTRCollectionFormPropertyRenderer
	...
	public Field getPropertyField(FormProperty formProperty) {
		...
		if (values != null && values.size() > 0) {
			...
			String id = i18nManager.getMessage(PERFORMANCE_VEICOLI_TR_TABLE_FIELDS + "targa");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(PERFORMANCE_VEICOLI_TR_TABLE_FIELDS + "tipoalimentazione");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(PERFORMANCE_VEICOLI_TR_TABLE_FIELDS + "classeEcologica");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(PERFORMANCE_VEICOLI_TR_TABLE_FIELDS + "numeromissioni");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(PERFORMANCE_VEICOLI_TR_TABLE_FIELDS + "numerokm");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(PERFORMANCE_VEICOLI_TR_TABLE_FIELDS + "consumoTotale");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(PERFORMANCE_VEICOLI_TR_TABLE_FIELDS + "numeroMedioConsegneAMissione");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(PERFORMANCE_VEICOLI_TR_TABLE_FIELDS + "percentualeConsegneABuonFine");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(PERFORMANCE_VEICOLI_TR_TABLE_FIELDS + "numeroMedioDiRitiriAMissione");
			table.addContainerProperty(id, String.class, null);
	...
	private Object[] getValues(PerformanceVeicoli type, FormProperty formProperty) {
		...
		I18nManager i18nManager = get().getI18nManager();
		try {
			tipoAlimentazione = i18nManager.getMessage(PERFORMANCE_VEICOLI_TR_TABLE_FIELDS + tipoAlimentazione);
		} catch (Exception ex) {
