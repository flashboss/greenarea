...
public class RichiediReportMissioniOpPanel extends VerticalLayout {
	...
	public RichiediReportMissioniOpPanel(Task task, DettaglioPage taskPage) {
		this.task = task;
	...
	protected void initTaskForm() {
		...
		if (formData != null && formData.getFormProperties() != null
			...
			if (task.getTaskDefinitionKey().equals(
					"visualizzaReportDettaglioConsegne")
					|| task.getTaskDefinitionKey().equals(
							"visualizzaReportSintesiMissioni")
					|| task.getTaskDefinitionKey().equals(
							"visualizzaReportDettaglioMissioni"))
