...
import it.vige.greenarea.bpm.custom.ui.dettaglio.trasportatoreautonomo.performanceveicoli.PerformanceVeicoliTrPage;
import it.vige.greenarea.bpm.custom.ui.dettaglio.trasportatoreautonomo.performanceveicoli.PerformanceVeicoliTrPanel;
...
public class PerformanceVeicoli extends AbstractProcessDefinitionDetailPanel {
	...
	public PerformanceVeicoli(String processDefinitionId, TrasportatoreAutonomoDetailPanel detailPanel) {
	...
	public void goToDettaglio() {
		...
		Component detailComponent = new PerformanceVeicoliTrPanel(task,
				new PerformanceVeicoliTrPage(processInstance.getId(), mainTitle));
