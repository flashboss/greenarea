...
public class VisualizzaMissioniAutorizzatePAPage extends DettaglioPage {
	...
	public VisualizzaMissioniAutorizzatePAPage(String processInstanceId, Label mainTitle) {
	...
	protected Component createDetailComponent(String id) {
		...
		Component detailComponent = new VisualizzaMissioniAutorizzatePAPanel(task, this);
