...
public class LetturaFiltriPanel extends VerticalLayout {

	private static final long serialVersionUID = 244734131312540078L;
	...
	public LetturaFiltriPanel(Task task, DettaglioPage taskPage) {
		this.task = task;
