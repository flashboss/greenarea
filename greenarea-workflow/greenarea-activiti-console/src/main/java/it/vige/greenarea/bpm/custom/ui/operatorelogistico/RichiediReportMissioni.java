...
import it.vige.greenarea.bpm.custom.ui.dettaglio.operatorelogistico.richiedireportmissioni.RichiediReportMissioniOpPage;
import it.vige.greenarea.bpm.custom.ui.dettaglio.operatorelogistico.richiedireportmissioni.RichiediReportMissioniOpPanel;
import it.vige.greenarea.bpm.custom.ui.form.GreenareaFormPropertiesForm;

public class RichiediReportMissioni extends AbstractProcessDefinitionDetailPanel {
	...
	public RichiediReportMissioni(String processDefinitionId, OperatoreLogisticoDetailPanel detailPanel) {
	...
	public void goToDettaglio() {
		...
		Component detailComponent = new RichiediReportMissioniOpPanel(task,
				new RichiediReportMissioniOpPage(processInstance.getId(), mainTitle));
