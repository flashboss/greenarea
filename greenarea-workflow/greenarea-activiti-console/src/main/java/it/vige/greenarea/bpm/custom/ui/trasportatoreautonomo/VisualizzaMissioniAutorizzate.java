...
import it.vige.greenarea.bpm.custom.ui.dettaglio.trasportatoreautonomo.visualizzamissioniautorizzate.VisualizzaMissioniAutorizzateTrPage;
import it.vige.greenarea.bpm.custom.ui.dettaglio.trasportatoreautonomo.visualizzamissioniautorizzate.VisualizzaMissioniAutorizzateTrPanel;
...
public class VisualizzaMissioniAutorizzate extends AbstractProcessDefinitionDetailPanel {
	...
	public VisualizzaMissioniAutorizzate(String processDefinitionId, TrasportatoreAutonomoDetailPanel detailPanel) {
	...
	public void goToDettaglio() {
		...
		Component detailComponent = new VisualizzaMissioniAutorizzateTrPanel(task,
				new VisualizzaMissioniAutorizzateTrPage(processInstance.getId(), mainTitle));
