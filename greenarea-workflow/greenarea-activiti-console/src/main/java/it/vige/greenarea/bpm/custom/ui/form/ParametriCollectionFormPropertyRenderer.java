...
import static it.vige.greenarea.bpm.custom.GreenareaMessages.PARAMETRI_AGGIUNTI_TABLE_FIELDS;
...
import it.vige.greenarea.bpm.form.ParametriCollectionFormType;
import it.vige.greenarea.dto.Parametro;

public class ParametriCollectionFormPropertyRenderer extends GreenareaAbstractFormPropertyRenderer<Parametro> {
	...
	public ParametriCollectionFormPropertyRenderer() {
		super(ParametriCollectionFormType.class);
	}
