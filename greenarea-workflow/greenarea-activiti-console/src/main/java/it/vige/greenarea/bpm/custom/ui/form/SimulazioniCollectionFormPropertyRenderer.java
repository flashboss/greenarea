...
public class SimulazioniCollectionFormPropertyRenderer extends GreenareaAbstractFormPropertyRenderer<Request> {
	...
	public Field getPropertyField(FormProperty formProperty) {
		...
		if (values != null && values.size() > 0) {
			...
			String id = i18nManager.getMessage(SIMULAZIONI_TABLE_FIELDS + "compagnia");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(SIMULAZIONI_TABLE_FIELDS + "nome");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(SIMULAZIONI_TABLE_FIELDS + "numeroconsegnepreviste");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(SIMULAZIONI_TABLE_FIELDS + "numeroritiriprevisti");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(SIMULAZIONI_TABLE_FIELDS + "carico");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(SIMULAZIONI_TABLE_FIELDS + "tipoalimentazione");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(SIMULAZIONI_TABLE_FIELDS + "euro");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(SIMULAZIONI_TABLE_FIELDS + "caricopercentuale");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(SIMULAZIONI_TABLE_FIELDS + "ranking");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(SIMULAZIONI_TABLE_FIELDS + "creditomobilita");
			table.addContainerProperty(id, String.class, null);
	...
	private Object[] getValues(Missione type, FormProperty formProperty) {
		...
		try {
			tipoAlimentazione = i18nManager.getMessage(SIMULAZIONI_TABLE_FIELDS + tipoAlimentazione);
		} catch (Exception ex) {
			logger.error("errore internazionalizzazione ", tipoAlimentazione);
		}
		result.add(tipoAlimentazione);
		result.add(i18nManager.getMessage(SIMULAZIONI_TABLE_FIELDS + "euro_value") + " "
