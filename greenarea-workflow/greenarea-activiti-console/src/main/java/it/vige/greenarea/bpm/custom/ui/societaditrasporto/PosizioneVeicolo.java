...
public class PosizioneVeicolo extends ReportDetailPanel {
	...
	public PosizioneVeicolo(String processDefinitionId, SocietaDiTrasportoDetailPanel detailPanel) {
	...
	protected void generateReport(ProcessInstance processInstance) {
		...
		posizioneVeicoloInstance = ProcessEngines.getDefaultProcessEngine().getHistoryService()
