...
public class VisualizzaMissioniAutorizzateStPanel extends VerticalLayout {
	...
	public VisualizzaMissioniAutorizzateStPanel(Task task,
	...
	protected void initTaskForm() {
		...
		if (formData != null && formData.getFormProperties() != null
			...
			final VisualizzaMissioniAutorizzateStPanel visualizzaMissioniAutorizzateStPanel = this;
			taskForm.addListener(new FormPropertiesEventListener() {
				...
				protected void handleFormSubmit(FormPropertiesEvent event) {
					...
					String missioni_autorizzate_op_missione = properties
							.get("missioni_autorizzate_st_missione");
					if (missioni_autorizzate_op_missione != null
							&& missioni_autorizzate_op_missione.equals(""))
						properties.remove("missioni_autorizzate_st_missione");
					...
					if (tasks.size() == 1) {
						task = tasks.get(0);
						visualizzaMissioniAutorizzateStPanel.setTask(task);
						visualizzaMissioniAutorizzateStPanel.attach();
					} else
