...
public class LetturaParametriPage extends DettaglioPage {

	private static final long serialVersionUID = 1L;

	public LetturaParametriPage(String processInstanceId, Label mainTitle) {
	...
	protected Component createDetailComponent(String id) {
		...
		Component detailComponent = new LetturaParametriPanel(task, this);
