...
import it.vige.greenarea.bpm.custom.ui.dettaglio.operatorelogistico.verificastatoconsegneeritiri.VerificaStatoConsegneERitiriPage;
import it.vige.greenarea.bpm.custom.ui.dettaglio.operatorelogistico.verificastatoconsegneeritiri.VerificaStatoConsegneERitiriPanel;
...
public class VerificaStatoConsegneERitiri extends
	...
	public VerificaStatoConsegneERitiri(String processDefinitionId,
	...
	public void goToDettaglio() {
		...
		Component detailComponent = new VerificaStatoConsegneERitiriPanel(task,
				new VerificaStatoConsegneERitiriPage(processInstance.getId(),
						mainTitle));
