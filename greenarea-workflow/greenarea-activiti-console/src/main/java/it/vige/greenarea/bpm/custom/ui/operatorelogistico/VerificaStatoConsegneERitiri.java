...
public class VerificaStatoConsegneERitiri extends AbstractProcessDefinitionDetailPanel {
	...
	public VerificaStatoConsegneERitiri(String processDefinitionId, OperatoreLogisticoDetailPanel detailPanel) {
	...
	public void goToDettaglio() {
		...
		Component detailComponent = new VerificaStatoConsegneERitiriPanel(task,
				new VerificaStatoConsegneERitiriPage(processInstance.getId(), mainTitle));
