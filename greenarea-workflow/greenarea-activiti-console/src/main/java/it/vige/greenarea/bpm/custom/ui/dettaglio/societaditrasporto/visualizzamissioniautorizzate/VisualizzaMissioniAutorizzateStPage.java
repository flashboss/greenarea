...
public class VisualizzaMissioniAutorizzateStPage extends DettaglioPage {
	...
	public VisualizzaMissioniAutorizzateStPage(String processInstanceId, Label mainTitle) {
	...
	protected Component createDetailComponent(String id) {
		...
		Component detailComponent = new VisualizzaMissioniAutorizzateStPanel(task, this);
