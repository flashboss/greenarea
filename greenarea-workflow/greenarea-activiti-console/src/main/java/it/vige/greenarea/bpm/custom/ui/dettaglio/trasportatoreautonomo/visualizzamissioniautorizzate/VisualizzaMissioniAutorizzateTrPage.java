...
public class VisualizzaMissioniAutorizzateTrPage extends DettaglioPage {
	...
	public VisualizzaMissioniAutorizzateTrPage(String processInstanceId, Label mainTitle) {
	...
	protected Component createDetailComponent(String id) {
		...
		Component detailComponent = new VisualizzaMissioniAutorizzateTrPanel(task, this);
