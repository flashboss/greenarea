...
import it.vige.greenarea.bpm.form.MissioniTRCollectionFormType;
import it.vige.greenarea.dto.Missione;
import it.vige.greenarea.dto.Pacco;
import it.vige.greenarea.dto.Richiesta;

public class MissioniTRCollectionFormPropertyRenderer extends GreenareaAbstractFormPropertyRenderer<Missione> {
	...
	public MissioniTRCollectionFormPropertyRenderer() {
		super(MissioniTRCollectionFormType.class);
	}
	...
	public Field getPropertyField(FormProperty formProperty) {
		...
		if (values != null && values.size() > 0) {
			...
			String id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "nome");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "codicefiliale");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "statomissione");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "numeroconsegnepreviste");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "numerocollidaconsegnare");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "numeroritiriprevisti");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "numerocollidaritirare");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "carico");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "targaveicolo");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "euro");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "tipoalimentazione");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "caricopercentuale");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "ranking");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "creditomobilita");
			table.addContainerProperty(id, String.class, null);
	...
	private Object[] getValues(Missione type, FormProperty formProperty) {
		...
		result.add(i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + "euro_value") + " "
				+ type.getVeicolo().getValori().getEuro());
		String tipoAlimentazione = type.getVeicolo().getValori().getFuel();
		try {
			tipoAlimentazione = i18nManager.getMessage(MISSIONI_TR_TABLE_FIELDS + tipoAlimentazione);
		} catch (Exception ex) {
