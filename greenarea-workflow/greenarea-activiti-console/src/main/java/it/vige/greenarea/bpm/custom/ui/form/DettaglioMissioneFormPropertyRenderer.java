...
public class DettaglioMissioneFormPropertyRenderer<T> extends GreenareaAbstractFormPropertyRenderer<T> {
	/**
	 * 
	 */
	...
	public Field getPropertyField(FormProperty arg0) {
		...
		DettaglioMissioneField<T> field = new DettaglioMissioneField<T>(arg0, this, missione);
		return field;
	}
}
