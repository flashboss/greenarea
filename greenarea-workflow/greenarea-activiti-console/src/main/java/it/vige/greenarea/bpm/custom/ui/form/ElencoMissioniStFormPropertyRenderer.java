...
public class ElencoMissioniStFormPropertyRenderer<T> extends GreenareaAbstractFormPropertyRenderer<T> {
	...
	private boolean isUser(String idMissione, String user) {
		...
		GreenareaUser greenareaUser = missioni.get(0).getVeicolo().getSocietaDiTrasporto();
