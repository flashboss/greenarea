...
public class MissioniOPSintesiFormPropertyRenderer extends GreenareaAbstractFormPropertyRenderer<Missione> {
	...
	public Field getPropertyField(FormProperty formProperty) {
		...
		table = new GreenareaPagedTable<Missione>(valuesMissioni, getGreenareaFormPropertiesForm());
		...
		if (values != null && values.size() > 0) {
			...
			String id = i18nManager.getMessage(MISSIONI_OP_SINTESI_TABLE_FIELDS + "nome");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_OP_SINTESI_TABLE_FIELDS + "codicefiliale");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_OP_SINTESI_TABLE_FIELDS + "codicespedizioniere");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_OP_SINTESI_TABLE_FIELDS + "numerocolliconsegnati");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_OP_SINTESI_TABLE_FIELDS + "numerocollidaritirare");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_OP_SINTESI_TABLE_FIELDS + "euro");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_OP_SINTESI_TABLE_FIELDS + "tipoalimentazione");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_OP_SINTESI_TABLE_FIELDS + "caricopercentuale");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_OP_SINTESI_TABLE_FIELDS + "ranking");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_OP_SINTESI_TABLE_FIELDS + "creditomobilita");
			table.addContainerProperty(id, String.class, null);
			id = i18nManager.getMessage(MISSIONI_OP_SINTESI_TABLE_FIELDS + "bonus");
			table.addContainerProperty(id, String.class, null);
	...
	private Object[] getValues(Missione type, FormProperty formProperty) {
		...
		if (veicolo.getSocietaDiTrasporto() != null && veicolo.getSocietaDiTrasporto().getId() != null
		...
		result.add(i18nManager.getMessage(MISSIONI_OP_SINTESI_TABLE_FIELDS + "euro_value") + " "
				+ veicolo.getValori().getEuro());
		String tipoAlimentazione = veicolo.getValori().getFuel();
		try {
			tipoAlimentazione = i18nManager.getMessage(MISSIONI_OP_SINTESI_TABLE_FIELDS + tipoAlimentazione);
		} catch (Exception ex) {
