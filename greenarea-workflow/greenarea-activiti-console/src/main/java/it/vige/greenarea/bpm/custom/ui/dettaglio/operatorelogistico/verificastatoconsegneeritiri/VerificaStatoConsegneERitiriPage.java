...
public class VerificaStatoConsegneERitiriPage extends DettaglioPage {
	...
	public VerificaStatoConsegneERitiriPage(String processInstanceId, Label mainTitle) {
	...
	protected Component createDetailComponent(String id) {
		...
		Component detailComponent = new VerificaStatoConsegneERitiriPanel(task, this);
