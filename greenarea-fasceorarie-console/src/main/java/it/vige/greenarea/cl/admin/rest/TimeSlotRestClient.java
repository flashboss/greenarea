...
public class TimeSlotRestClient {
	...
	public List<ParameterGen> findAllParameterGen() throws Exception {
		...
		Invocation.Builder bldr = client.target(
				BASE_URI + "/findAllParameterGen").request(APPLICATION_JSON);
	...
	public List<ParameterGen> findAllParameterGenAvailable() throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(
				BASE_URI + "/findAllParameterGenAvailable").request(
				APPLICATION_JSON);
		return bldr.get(new GenericType<List<ParameterGen>>() {
		});
	}
	...
	public List<TimeSlot> findAllTimeSlots() throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(BASE_URI + "/findAllTimeSlot")
	...
	public List<TsStat> getAllTsStats() throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(BASE_URI + "/getAllTsStats")
				.request(APPLICATION_JSON);
	...
	public List<Sched> getAllSchedules() throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(BASE_URI + "/getAllSchedules")
				.request(APPLICATION_JSON);
		return bldr.get(new GenericType<List<Sched>>() {
		});
	}

	public List<Request> selectRequests(Date dateMiss, String idTimeSlot,
			String typePG) throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(
				BASE_URI + "/requests/" + dateMiss + "/" + idTimeSlot + "/"
						+ typePG).request(APPLICATION_JSON);
		return bldr.get(new GenericType<List<Request>>() {
		});
	}

	public List<Request> simulRank(String idTimeSlot, Date dateMiss)
			throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(
				BASE_URI + "/simulRank/" + idTimeSlot + "/" + dateMiss)
				.request(APPLICATION_JSON);
		return bldr.get(new GenericType<List<Request>>() {
		});
	}
	...
	public List<ParameterTS> findTimeSlot(String idTimeSlot) throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(
				BASE_URI + "/findTimeSlot/" + idTimeSlot).request(
				APPLICATION_JSON);
		return bldr.get(new GenericType<List<ParameterTS>>() {
		});
	}

	public List<Request> getStoryBoard(String idTimeSlot, Date dateMiss)
			throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(
				BASE_URI + "/getStoryBoard/" + idTimeSlot + "/" + dateMiss)
				.request(APPLICATION_JSON);
		return bldr.get(new GenericType<List<Request>>() {
		});
	}

	public List<ParameterTS> findParameterOfTimeSlot(String idTimeSlot)
			throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(
				BASE_URI + "/findParameterOfTimeSlot/" + idTimeSlot).request(
				APPLICATION_JSON);
		return bldr.get(new GenericType<List<ParameterTS>>() {
		});
	}
	...
	public List<Price> getPriceOfTimeSlot(String idTimeSlot) throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(
				BASE_URI + "/getPriceOfTimeSlot/" + idTimeSlot).request(
				APPLICATION_JSON);
		return bldr.get(new GenericType<List<Price>>() {
		});
	}

	public ParameterTS configParameterTsToTimeSlot(Object requestEntity)
			throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client
				.target(BASE_URI + "/configParameterTS").request(
						APPLICATION_JSON);
		return bldr.post(entity(requestEntity, APPLICATION_JSON),
				ParameterTS.class);
	}

	public ParameterTS getParameterOfTimeSlot(String idTimeSlot)
			throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(
				BASE_URI + "/getParameterForRank/" + idTimeSlot).request(
				APPLICATION_JSON);
		return bldr.get(ParameterTS.class);
	}

	public List<Request> getrRank(String idTimeSlot, Date dateMiss)
			throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(
				BASE_URI + "/getRank/" + idTimeSlot + "/" + dateMiss).request(
				APPLICATION_JSON);
		return bldr.get(new GenericType<List<Request>>() {
		});
	}
	...
	public TimeSlotInfo getInfoTimeSlot(String idTimeSlot) throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(
				BASE_URI + "/getInfoTimeSlot/" + idTimeSlot).request(
				APPLICATION_JSON);
		return bldr.get(TimeSlotInfo.class);
	}

	public ParameterGen updateParameterGen(ParameterGen requestEntity)
			throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(
				BASE_URI + "/updateParameterGen").request(APPLICATION_JSON);
		return bldr.post(entity(requestEntity, APPLICATION_JSON),
				ParameterGen.class);
	}
	...
	public List<Vehicle> getAllVehicles() throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(BASE_URI + "/getVehicles")
				.request(APPLICATION_JSON);
	...
	public ParameterGen addParameterGen(Object requestEntity) throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(BASE_URI + "/addParameterGen")
				.request(APPLICATION_JSON);
		return bldr.post(entity(requestEntity, APPLICATION_JSON),
				ParameterGen.class);
	}
	...
	public Price addPrices(Object requestEntity) throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(BASE_URI + "/addPrice")
				.request(APPLICATION_JSON);
	...
	public TimeSlot addTimeSlot(Object requestEntity) throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(BASE_URI + "/addTimeSlot")
				.request(APPLICATION_JSON);
		return bldr.post(entity(requestEntity, APPLICATION_JSON),
				TimeSlot.class);
	}
	...
	public String simulSch(Transport transport) throws Exception {
		Client client = newClient();
		Invocation.Builder bldr = client.target(BASE_URI + "/startScheduler")
				.request(APPLICATION_JSON);
