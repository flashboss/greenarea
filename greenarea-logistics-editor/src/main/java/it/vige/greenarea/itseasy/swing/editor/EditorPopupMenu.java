...
public class EditorPopupMenu extends JPopupMenu {
	...
	public EditorPopupMenu(BasicGraphEditor editor) {
		...
		add(editor.bind(mxResources.get("cut"), TransferHandler.getCutAction(),
				"/it/vige.greenarea/itseasy/swing/images/cut.gif")).setEnabled(selected);
		add(editor.bind(mxResources.get("copy"), TransferHandler.getCopyAction(),
				"/it/vige.greenarea/itseasy/swing/images/copy.gif")).setEnabled(selected);
		...
		add(editor.bind(mxResources.get("delete"), mxGraphActions.getDeleteAction(),
				"/it/vige.greenarea/itseasy/swing/images/delete.gif")).setEnabled(selected);
