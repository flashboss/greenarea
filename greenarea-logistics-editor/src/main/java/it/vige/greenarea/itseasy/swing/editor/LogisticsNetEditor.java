...
public class LogisticsNetEditor extends BasicGraphEditor {
	...
	private static CustomGraphComponent graphComponent = new CustomGraphComponent(
			LNutilities.getLogisticNetwork());
	...
	public LogisticsNetEditor(String appTitle, mxGraphComponent component) {
		 ...
		 * "icon;image=/it/vige/itseasy/swing/images/wrench.png", 70,
		 * 70, "Icon"); shapesPalette .addTemplate( "Label", new ImageIcon(
		 * GraphEditor.class
		 * .getResource("/it/vige/itseasy/swing/images/rounded.png")),
		 * "label;image=/it/vige/itseasy/swing/images/gear.png", 130,
		 * 50, "Label"); shapesPalette .addTemplate( "Rectangle", new ImageIcon(
		 * GraphEditor.class
		 * .getResource("/it/vige/itseasy/swing/images/rectangle.png"
		 * )), null, 160, 120, ""); shapesPalette .addTemplate(
		 * "Rounded Rectangle", new ImageIcon( GraphEditor.class
		 * .getResource("/it/vige/itseasy/swing/images/rounded.png")),
		...
		shapesPalette
				.addTemplate(
						"Horizontal Line",
						new ImageIcon(
								LogisticsNetEditor.class
										.getResource("/it/vige/itseasy/swing/images/hline.png")),
						"line", 160, 10, "");
		/*
		...
		shapesPalette
				.addEdgeTemplate(
						...
						new ImageIcon(
								LogisticsNetEditor.class
										.getResource("/it/vige/itseasy/swing/images/straight.png")),
						"straight", 120, 120, "");

		shapesPalette
				.addEdgeTemplate(
						I18N.getString("GenericVector"),
						new ImageIcon(
								LogisticsNetEditor.class
										.getResource("/it/vige/itseasy/swing/images/connect.png")),
						null, 100, 100,
						(new LNSimpleCarrier(I18N.getString("UNDEFINED"))));
		shapesPalette
				.addEdgeTemplate(
						"Vertical Connector",
						new ImageIcon(
								LogisticsNetEditor.class
										.getResource("/it/vige/itseasy/swing/images/vertical.png")),
						"vertical", 100, 100, "");
		...
		imagesPalette
				.addTemplate(
						...
						new ImageIcon(
								LogisticsNetEditor.class
										.getResource("/it/vige/itseasy/swing/images/area.png")),
						"roundImage;image=/it/vige/itseasy/swing/images/area.png",
						50, 50, (new LNArea("Area")));
		imagesPalette
				.addTemplate(
						"Aeroporto",
						new ImageIcon(
								LogisticsNetEditor.class
										.getResource("/it/vige/itseasy/swing/images/aeroporto.png")),
						"roundImage;image=/it/vige/itseasy/swing/images/aeroporto.png",
						50, 50, (new LNSite("Aeroporto")));
		imagesPalette
				.addTemplate(
						"Stazione",
						new ImageIcon(
								LogisticsNetEditor.class
										.getResource("/it/vige/itseasy/swing/images/icon-train-station.png")),
						"roundImage;image=/it/vige/itseasy/swing/images/icon-train-station.png",
						50, 50, (new LNSite("Stazione")));
		imagesPalette
				.addTemplate(
						"Citta'",
						new ImageIcon(
								LogisticsNetEditor.class
										.getResource("/it/vige/itseasy/swing/images/city.png")),
						"roundImage;image=/it/vige/itseasy/swing/images/city.png",
						50, 50, (new LNArea("Citta'", LNArea.AreaLevel.city)));
		imagesPalette
				.addTemplate(
						"InterModale",
						new ImageIcon(
								LogisticsNetEditor.class
										.getResource("/it/vige/itseasy/swing/images/IntermodalExchange.png")),
						"roundImage;image=/it/vige/itseasy/swing/images/IntermodalExchange.png",
						50, 50, (new LNSite("InterModale")));
		imagesPalette
				.addTemplate(
						"Sede Centrale",
						new ImageIcon(
								LogisticsNetEditor.class
										.getResource("/it/vige/itseasy/swing/images/hq.png")),
						"roundImage;image=/it/vige/itseasy/swing/images/hq.png",
						50, 50, (new LNSite("Sede Centrale")));
		imagesPalette
				.addTemplate(
						"Produzione",
						new ImageIcon(
								LogisticsNetEditor.class
										.getResource("/it/vige/itseasy/swing/images/factory.png")),
						"roundImage;image=/it/vige/itseasy/swing/images/factory.png",
						50, 50, (new LNSite("Produzione")));
		imagesPalette
				.addTemplate(
						"Pool",
						new ImageIcon(
								LogisticsNetEditor.class
										.getResource("/it/vige/itseasy/swing/images/sitesSet.png")),
						"roundImage;image=/it/vige/itseasy/swing/images/sitesSet.png",
						50, 50, (new LNSitesSet("Pool")));
		editor = this;
	}
	...
	*/
	public static class CustomGraphComponent extends mxGraphComponent {
		...
		public CustomGraphComponent(mxGraph graph) {
			...
			Document doc = mxUtils
					.loadDocument(LogisticsNetEditor.class
							.getResource(
									"/it/vige/itseasy/swing/resources/default-style.xml")
							.toString());
	...
	public static void main(String[] args) {
		...
		editorMenuBar.add(new LogisticsActionsMenu(editor),
				editorMenuBar.getMenuCount() - 1);
