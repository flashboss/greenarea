	...
	public static void initialize() {
		...
		if (proxySet != null)
			if (proxySet.equals("true")) {
				...
				if (p != null)
					System.setProperty("http.nonProxyHosts", p); // Per loquendo
																	// deve
																	// avere non
																	// proxy
				p = Application.getProperty("http.proxyUser");
				if (p != null)
					System.setProperty("http.proxyUser", p);
				...
				class MyAuthenticator extends Authenticator {
					...
					protected PasswordAuthentication getPasswordAuthentication() {
						...
						return new PasswordAuthentication(Application.getProperty("http.proxyUser"),
								Application.getProperty("http.proxyPassword").toCharArray());
					}
				}
